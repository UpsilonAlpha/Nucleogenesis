...
public class Tile : MonoBehaviour
{
    ...
    void Apply(int index)
    {
        ...
        ElementName.color = Color.black;
        ElementImage.color = Element.instance.elementDetails[index].ElementColor;
        Shell.AddShell(index, Element.instance.elementDetails[index].ElementColor, Element.instance.elementDetails[index].Name);
    }
